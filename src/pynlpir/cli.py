...
LICENSE_URL = (
    "https://github.com/NLPIR-team/NLPIR/raw/master/License/license"
...
@click.option(
    "-d",
    "--data-dir",
    help="The NLPIR data directory to use.",
...
def update(data_dir):
    ...
    try:
        ...
        click.secho("Error: unable to move license to data directory.", fg="red")
        exit(1)
